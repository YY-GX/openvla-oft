#!/bin/bash
# Launch 10 parallel processes for demo generation in make-up mode
# Each process processes only skills in MAKE_UP_BDDL_SKILLS with different random seeds and output folders
