...
sbatch \
  ...
  --wrap="torchrun --standalone --nnodes 1 --nproc-per-node 8 vla-scripts/finetune.py \
    --resume True \
    --resume_step 10000 \
    --vla_path '/mnt/arc/yygx/pkgs_baselines/openvla-oft/runs/view_2/1.0.2/openvla-7b+libero_local3+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--parallel_dec--8_acts_chunk--continuous_acts--L1_regression--3rd_person_img--wrist_img--proprio_state--10000_chkpt' \
