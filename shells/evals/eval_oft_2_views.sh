...
#  --pretrained_checkpoint "/mnt/arc/yygx/pkgs_baselines/openvla-oft/runs/view_2/1.0.1/openvla-7b+libero_local2+b4+lr-0.0005+lora-r32+dropout-0.0--image_aug--parallel_dec--8_acts_chunk--continuous_acts--L1_regression--3rd_person_img--wrist_img--proprio_state--100000_chkpt" \
