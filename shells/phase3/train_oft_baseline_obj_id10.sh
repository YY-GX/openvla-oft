...
# Baseline OFT-OBJ Long ID 10 Training - OpenVLA-OFT LoRA Finetuning on Baseline OFT-OBJ Dataset
#
...
CPUS_PER_TASK=64
GPUS=8
JOB_NAME="baseline_obj_id10"
LOG_DIR="$ENDPOINT/pkgs_baselines/openvla-oft/logs"
LOG_FILE="train_baseline_obj_id10_%j.out"
