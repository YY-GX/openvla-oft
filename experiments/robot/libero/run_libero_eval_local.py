...
TASK_MAX_STEPS = {
    ...
    TaskSuite.LIBERO_LOCAL3: 400,  # longest training demo has 373 steps
    TaskSuite.GL_SIZE: 400,  # longest training demo has 373 steps
    TaskSuite.BOSS_44: 400,  # longest training demo has 373 steps
}
